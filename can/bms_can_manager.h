...
private:
    ...
    //Response handlers
    void handle_voltage_response(const QCanBusFrame &message);
    void handle_charge_discharge_response(const QCanBusFrame &message);
    void handle_status_response(const QCanBusFrame &message);
    void handle_cell_voltage_response(const QCanBusFrame &message);
    void handle_temperature_response(const QCanBusFrame &message);
    void handle_failure_response(const QCanBusFrame &message);
