...
private:
    ...
    void handle_electrical_data(const QCanBusFrame &message, motor_electrical_data_t &data);
    void handle_state_data(const QCanBusFrame &message, motor_state_data_t &data);
